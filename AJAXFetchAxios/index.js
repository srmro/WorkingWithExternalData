...
const API_KEY =
  "live_GMQWUu2kFPAFdg2BJasYIyMvCA6DELlEYavldEc2cQ1hLdAavL9aH1c6MttYGuB5";
...
document
  ...
  .addEventListener("change", async function () {
    ...
    // Fetch breed images
    const response = await fetch(
      `https://api.thecatapi.com/v1/images/search?api_key=${API_KEY}&breed_ids=${breedId}&limit=10`
    );
    const images = await response.json();
