...
var API_KEY = "live_GMQWUu2kFPAFdg2BJasYIyMvCA6DELlEYavldEc2cQ1hLdAavL9aH1c6MttYGuB5";

/**
 * 1. Create an async function "initialLoad" that does the following:
 * - Rtrieve a list of breeds from the cat API using fetch().
...
document.getElementById("breedSelect").addEventListener("change", /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  var breedId, response, progressBar, carouselInner, infoDump, images;
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        ...
        _context.next = 4;
        return fetch("https://api.thecatapi.com/v1/images/search?api_key=" + API_KEY + "&breed_ids=" + breedId + "&limit=10");
      case 4:
      ...
      case 11:
        ...
        images.forEach(function (image, index) {
          ...
          img.src = image.url;
          img.classList.add("d-block", "w-100"); // Bootstrap classes for proper styling
...
document.getElementById("breedSelect").addEventListener("change", /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
  var _images$, _images$$breeds;
  var breedId, response, images, carouselInner, infoDump, breedInfo, breedDetails;
  return _regeneratorRuntime().wrap(function _callee2$(_context2) {
    while (1) switch (_context2.prev = _context2.next) {
      case 0:
        breedId = this.value; // Fetch breed images
        _context2.next = 3;
        return fetch("https://api.thecatapi.com/v1/images/search?api_key=".concat(API_KEY, "&breed_ids=").concat(breedId, "&limit=10"));
      case 3:
      ...
      case 6:
        ...
        images.forEach(function (image, index) {
          var carouselItem = Carousel.createCarouselItem(image.url, "Image of ".concat(image.id), image.id);
        ...
        if ((_images$ = images[0]) !== null && _images$ !== void 0 && (_images$$breeds = _images$.breeds) !== null && _images$$breeds !== void 0 && _images$$breeds.length) {
...
// Hint: use forEach
// Hint: Use the following, reference Carousel.js
...
// defined above: const breedSelect = document.getElementById("breedSelect");
...
},{"bootstrap":"node_modules/bootstrap/dist/js/bootstrap.esm.js","./index.js":"index.js"}],"node_modules/.pnpm/parcel-bundler@1.12.5/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["node_modules/.pnpm/parcel-bundler@1.12.5/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","Carousel.js"], null)
